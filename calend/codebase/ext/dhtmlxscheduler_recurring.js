...
scheduler.config.occurrence_timestamp_in_utc = !1, scheduler.config.recurring_workdays = [1, 2, 3, 4, 5], scheduler.form_blocks.recurring = {
        ...
        _init_set_value: function(e, t, a) {
            ...
            var y = {
                    month: function(e, t) {
                        ...
                        "d" == a(g, "month_type") ? (e.push(Math.max(1, r(g, "month_count"))), t.start.setDate(a(g, "month_day"))) : (e.push(Math.max(1, r(g, "month_count2"))),
                            e.push(a(g, "month_day2")), e.push(Math.max(1, r(g, "month_week2"))), scheduler.config.repeat_precise || t.start.setDate(1)), t._start = !0
                    },
                    week: function(e, t) {
                        var a = scheduler.form_blocks.recurring._get_node_value,
                            r = scheduler.form_blocks.recurring._get_node_numeric_value;
                        ...
                        n.length || (n.push(s), d = !0), n.sort(), scheduler.config.repeat_precise ? d || (scheduler.transpose_day_week(t.start, n, 1, 7),
                            t._start = !0) : (t.start = scheduler.date.week_start(t.start), t._start = !0), e.push(n.join(","))
                    },
                    day: function(e) {
                    ...
                    year: function(e, t) {
                        ...
                        "d" == a(g, "year_type") ? (e.push("1"),
                            t.start.setMonth(0), t.start.setDate(a(g, "year_day")), t.start.setMonth(a(g, "year_month"))) : (e.push("1"), e.push(a(g, "year_day2")), e.push(a(g, "year_week2")), t.start.setDate(1), t.start.setMonth(a(g, "year_month2"))), t._start = !0
                    }
                },
                b = {
                    week: function(e, t) {
                    ...
                    year: function(e, t) {
                        var a = scheduler.form_blocks.recurring._set_node_value;
                        "" === e[2] ? (a(g, "year_type", "d"), a(g, "year_day", t.start.getDate()), a(g, "year_month", t.start.getMonth())) : (a(g, "year_type", "w"), a(g, "year_week2", e[3]), a(g, "year_day2", e[2]),
        ...
        set_value: function(e, t, a) {
            ...
            scheduler._lightbox._rec_init_done || r._init_set_value(e, t, a), e.open = !a.rec_type, e.blocked = this._is_modified_occurence(a);
            var n = r._ds;
            n.start = a.start_date, n.end = a._end_date, r._toggle_block(),
                t && r._set_repeat_code(t, n)
        },
        ...
        button_click: function(e, t, a, r) {
            var n = scheduler.form_blocks.recurring,
                r = n._get_form();
            r.blocked || scheduler.form_blocks.recurring._toggle_block()
        }
    }, scheduler._rec_markers = {}, scheduler._rec_markers_pull = {}, scheduler._add_rec_marker = function(e, t) {
        e._pid_time = t, this._rec_markers[e.id] = e, this._rec_markers_pull[e.event_pid] || (this._rec_markers_pull[e.event_pid] = {}),
    ...
    function() {
        ...
        if (this._is_virtual_event(e)) {
            ...
            var s = this._get_rec_markers(e);
            for (var d in s) s.hasOwnProperty(d) && (delete this._rec_markers[s[d].id],
                this.deleteEvent(s[d].id, !0));
            delete this._rec_markers_pull[e];
            for (var l = !1, o = 0; o < this._rendered.length; o++) this._rendered[o].getAttribute("event_id") == e && (l = !0);
    ...
    function() {
        ...
        if (!this.date[t]) {
            ...
            if ("day" == a[0] || "week" == a[0]) {
                ...
                var r = Math.ceil((12 * t.getFullYear() + 1 * t.getMonth() + 1 - (12 * e.getFullYear() + 1 * e.getMonth() + 1)) / i - 1);
        ...
        for (; n > d && d < e.end_date && (0 > s || s > o);) {
            d.setHours(l);
            var c = scheduler.config.occurrence_timestamp_in_utc ? Date.UTC(d.getFullYear(), d.getMonth(), d.getDate(), d.getHours(), d.getMinutes(), d.getSeconds()) : d.valueOf(),
                _ = this._get_rec_marker(c, e.id);
            if (_) a && ("none" != _.rec_type && o++, t.push(_));
            else {
                var h = new Date(d.valueOf() + 1e3 * e.event_length),
                    u = this._copy_event(e);
                if (u.text = e.text, u.start_date = d, u.event_pid = e.id, u.id = e.id + "#" + Math.ceil(c / 1e3), u.end_date = h, u.end_date = scheduler._fix_daylight_saving_date(u.start_date, u.end_date, e, d, u.end_date),
                    u._timed = this.isOneDayEvent(u), !u._timed && !this._table_view && !this.config.multi_day) return;
                t.push(u), a || (this._events[u.id] = u, this._rec_temp.push(u)), o++
            }
