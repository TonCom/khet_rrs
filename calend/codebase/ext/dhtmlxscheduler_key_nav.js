    ...
    function e(e) {
        function t(t) {
            var a = {
                ...
                i = {};
            for (var r in a) i[r.toLowerCase()] = a[r];
        ...
        e.config.key_nav = !0, e.config.key_nav_step = 30, e.addShortcut = function(e, a, i) {
                ...
                if (r) {
                    ...
                    if (n.length) return r.prototype.findHandler(n[0])
                }
            ...
            function() {
                e.$keyboardNavigation.getFocusableNodes = e._getFocusableNodes, e.$keyboardNavigation.trapFocus = function(t, a) {
                    ...
                    } else if (d = n >= i.length - 1 ? 0 : n + 1, o = i[d]) return o.focus(), a.preventDefault(), !0;
                    return !1
                }
                ...
                renderMultiple: function(t, a, i) {
                    for (var r = [], n = new Date(t), s = new Date(Math.min(a.valueOf(), e.date.add(e.date.day_start(new Date(t)), 1, "day").valueOf())); n.valueOf() < a.valueOf();) r = r.concat(i.call(this, n, new Date(Math.min(s.valueOf(), a.valueOf())))), n = e.date.day_start(e.date.add(n, 1, "day")), s = e.date.day_start(e.date.add(n, 1, "day")), s = new Date(Math.min(s.valueOf(), a.valueOf()));
                    return r
                },
                ...
                addDataAttributes: function(t, a, i, r) {
                    for (var n = e.date.date_to_str(e.config.api_date), s = n(a), d = n(i), o = 0; o < t.length; o++) t[o].setAttribute("data-start-date", s), t[o].setAttribute("data-end-date", d), r && t[o].setAttribute("data-section", r)
                },
                addWaiAriaLabel: function(t, a, i, r) {
                    var n = "",
                        ...
                        d = s.mode,
                        o = !1;
                    n += e.templates.day_date(a), e.date.day_start(new Date(a)).valueOf() != a.valueOf() && (n += " " + e.templates.hour_scale(a), o = !0),
                        e.date.day_start(new Date(a)).valueOf() != e.date.day_start(new Date(i)).valueOf() && (n += " - " + e.templates.day_date(i), (o || e.date.day_start(new Date(i)).valueOf() != i.valueOf()) && (n += " " + e.templates.hour_scale(i))), r && (e.matrix && e.matrix[d] ? n += ", " + e.templates[d + "_scale_label"](r.key, r.label, r) : e._props && e._props[d] && (n += ", " + e.templates[d + "_scale_text"](r.key, r.label, r)));
                ...
                _wrapDiv: function(e) {
                    ...
                    return t.style.top = e.offsetTop + "px", t.style.left = e.offsetLeft + "px", t.style.width = e.offsetWidth + "px", t.style.height = e.offsetHeight + "px", e.appendChild(t), [t]
                },
                ...
                renderAgendaMarker: function(t, a) {
                    ...
                    return i.style.height = "1px", i.style.width = "100%", i.style.opacity = 1, i.style.top = "0px", i.style.left = "0px", e.$container.querySelector(".dhx_cal_data").appendChild(i), [i]
                },
                ...
                renderMonthCell: function(t) {
                    ...
                    for (var n = e.date.week_start(new Date(e.getState().min_date)), s = -1, d = 0, o = -1, l = n, c = e.date.day_start(new Date(t)), r = 0; r < i.length && (s++,
                            6 == o ? (d++, o = 0) : o++, e.date.day_start(new Date(l)).valueOf() != c.valueOf()); r++) l = e.date.add(l, 1, "day");
                    if (-1 == s) return [];
                    var h = e._colsS[o],
                ...
                renderMonthMarker: function(t, a) {
                    for (var i = [], r = t; r.valueOf() < a.valueOf();) i.push(this.renderMonthCell(r)),
                        r = e.date.add(r, 1, "day");
                    return i
                },
                renderVerticalMarker: function(t, a, i) {
                    ...
                    var _ = this.createElement(),
                        ...
                        v = 36e5;
                    return _.style.top = Math.round((60 * c * 1e3 - e.config.first_hour * v) * e.config.hour_size_px / v) % u + "px", _.style.lineHeight = _.style.height = Math.max(Math.round(60 * (h - c) * 1e3 * e.config.hour_size_px / v) % u, 1) + "px", _.style.width = "100%", s.appendChild(_), n.push(_), n[0]
                }
                ...
                _pickEvent: function(t, a, i, r) {
                    ...
                    for (var o = 0; o < s.length; o++) {
                        var l = new e.$keyboardNavigation.Event(s[o].id);
                        if (l.getNode()) return s[o]
                    }
                    return null
                },
                ...
                keys: {
                    "alt+1, alt+2, alt+3, alt+4, alt+5, alt+6, alt+7, alt+8, alt+9": function(t) {
                        var a = e.$keyboardNavigation.HeaderCell.prototype.getNodes(".dhx_cal_navline .dhx_cal_tab"),
                            i = t.key;
                        void 0 === i && (i = t.keyCode - 48),
                            a[1 * i - 1] && a[1 * i - 1].click()
                    },
            ...
            }), e.$keyboardNavigation.HeaderCell.prototype.bindAll(e.$keyboardNavigation.HeaderCell.prototype.keys), e.$keyboardNavigation.Event = function(t) {
            ...
            e.$keyboardNavigation.Event.prototype.bindAll(e.$keyboardNavigation.Event.prototype.keys), e.$keyboardNavigation.TimeSlot = function(t, a, i, r) {
                ...
                t || (t = this.getDefaultDate()), a || (a = s ? e.date.add(t, s.x_step, s.x_unit) : e.date.add(t, e.config.key_nav_step, "minute")), this.section = i || this._getDefaultSection(), this.start_date = new Date(t), this.end_date = new Date(a), this.movingDate = r || null
            }, e.$keyboardNavigation.TimeSlot.prototype = e._compose(e.$keyboardNavigation.KeyNavNode, {
                _handlers: null,
                getDefaultDate: function() {
                    var t, a = e.getState(),
                        i = e.matrix && e.matrix[a.mode];
                    if (i) t = e.date[i.name + "_start"](new Date(a.date)), t = this.findVisibleColumn(t);
                        ...
                        r.scrollTop && t.setHours(e.config.first_hour + Math.ceil(r.scrollTop / e.config.hour_size_px))
                    }
                    return t
                },
                clone: function(t) {
                ...
                nextTimelineSlot: function(t, a, i) {
                    ...
                    switch (o.start_date = s, o.end_date = d, o.section = t.section || this._getNextSection(), a) {
                        ...
                        case "left":
                            ...
                            break;
                        case "right":
                            o.start_date = this.findVisibleColumn(e.date.add(o.start_date, n.x_step, n.x_unit), 1),
                                o.end_date = e.date.add(o.start_date, n.x_step, n.x_unit)
                    }
            ...
            e.$keyboardNavigation.MinicalButton = function(e, t) {
                ...
                fallback: function() {
                    ...
                    i[t] || (t = 0);
                    var r = !0;
                    if (t > i.length / 2 && (r = !1), !i[t]) {
                        var n = new e.$keyboardNavigation.TimeSlot;
                        return n.isValid() ? n : new e.$keyboardNavigation.DataArea
                    }
                    if (r) {
                        for (var s = a; i[t] && s < i[t].length; s++)
                            if (i[t][s] || s != i[t].length - 1 || (t++, a = 0), i[t][s]) return new e.$keyboardNavigation.MinicalCell(this.container, t, s)
                    } else
                        for (var s = a; i[t] && s < i[t].length; s--)
                            if (i[t][s] || s || (t--, a = i[t].length - 1), i[t][s]) return new e.$keyboardNavigation.MinicalCell(this.container, t, s); return new e.$keyboardNavigation.MinicalButton(this.container, 0);
                },
                focus: function() {
                    e.$keyboardNavigation.dispatcher.globalNode.disable(), this.container.removeAttribute("tabindex"), e.$keyboardNavigation.KeyNavNode.prototype.focus.apply(this)
                },
            ...
            function() {
                ...
                var l = [];
                if (e.attachEvent("onLightbox", o),
                    e.attachEvent("onAfterLightbox", n), e.attachEvent("onAfterQuickInfo", function() {
                        i()
                ...
                function t(e) {
                    e = e || window.event, d.x = e.clientX,
                        d.y = e.clientY
                }
                ...
                document.body ? dhtmlxEvent(document.body, "mousemove", t) : dhtmlxEvent(window, "load", function() {
                    ...
                    var a = e.$keyboardNavigation._pasteDate,
                        ...
                        d = r(t);
                    if (i(d), d.start_date = new Date(a),
                        d.end_date = new Date(d.start_date.valueOf() + s), n) {
                        var o = e._get_section_property();
                        e.config.multisection ? d[o] = t[o] : d[o] = n
                    }
                    return d
                    ...
                    var d = n();
                    if ((t.ctrlKey || t.metaKey) && 67 == t.keyCode) return d && (e._buffer_event = r(e.getEvent(d)), s = !0, e.callEvent("onEventCopied", [e.getEvent(d)])), !0;
                    if ((t.ctrlKey || t.metaKey) && 88 == t.keyCode && d) {
                        s = !1;
                        var o = e._buffer_event = r(e.getEvent(d));
                    ...
                    if ((t.ctrlKey || t.metaKey) && 86 == t.keyCode && a(t)) {
                        ...
                        if (o = o || e._buffer_event) {
                            ...
                            if (s) l.id = e.uid(), e._do_paste(s, l, o);
                                ...
                                var c = e.callEvent("onBeforeEventChanged", [l, t, !1, o]);
                                c && (e._do_paste(s, l, o), s = !0)
                            }
                        }
                        return !0
                    }
            ...
            function() {
                ...
                e.$keyboardNavigation.attachSchedulerHandlers = function() {
                    function t(t) {
                        ...
                        var a, i = e.$keyboardNavigation.isChildOf(t.target || t.srcElement, e.$container.querySelector(".dhx_cal_data")),
                            n = e.getActionData(t);
                        e._locate_event(t.target || t.srcElement) ? a = new e.$keyboardNavigation.Event(e._locate_event(t.target || t.srcElement)) : i && (a = new e.$keyboardNavigation.TimeSlot, n.date && i && (a = a.nextSlot(new e.$keyboardNavigation.TimeSlot(n.date, null, n.section)))),
                            a && (r.isEnabled() ? n.date && i && r.delay(function() {
                                r.setActiveNode(a)
                            }) : r.activeNode = a)
                    }

                    function a(t) {
                        if (e.config.key_nav && r.isEnabled()) {
                            var a = t,
                                i = new e.$keyboardNavigation.Event(a.eventId);
                            if (!i.isValid()) {
                                var n = i.start || a.start,
                                    s = i.end || a.end,
                                    d = i.section || a.section;
                                i = new e.$keyboardNavigation.TimeSlot(n, s, d), i.isValid() || (i = new e.$keyboardNavigation.TimeSlot)
                            }
                            r.setActiveNode(i);
                            var o = r.getActiveNode();
                            o && o.getNode && document.activeElement != o.getNode() && r.focusNode(r.getActiveNode())
                        }
                    }
                    var i, r = e.$keyboardNavigation.dispatcher,
                        n = function(t) {
                            return e.config.key_nav ? r.keyDownHandler(t) : void 0
                        },
                        s = function() {
                            r.focusGlobalNode()
                        };
                    e.attachEvent("onDataRender", function() {
                        e.config.key_nav && r.isEnabled() && !e.getState().editor_id && (clearTimeout(i), i = setTimeout(function() {
                            r.isEnabled() || r.enable();
                            var t = r.getActiveNode();
                            t instanceof e.$keyboardNavigation.MinicalButton || t instanceof e.$keyboardNavigation.MinicalCell || (t.isValid() ? r.focusNode(t) : r.setActiveNode(t.fallback()), r.focusNode(r.getActiveNode()))
                        }))
                    }), e.attachEvent("onSchedulerReady", function() {
                        var a = e.$container;
                        e.eventRemove(document, "keydown", n), e.eventRemove(a, "mousedown", t), e.eventRemove(a, "focus", s), e.config.key_nav ? (e.event(document, "keydown", n), e.event(a, "mousedown", t), e.event(a, "focus", s), a.setAttribute("tabindex", "0")) : a.removeAttribute("tabindex")
                    });
                    var d = e.updateEvent;
                    e.updateEvent = function(t) {
                        var i = d.apply(this, arguments);
                        if (e.config.key_nav && r.isEnabled() && e.getState().select_id == t) {
                            var n = new e.$keyboardNavigation.Event(t);
                            e.getState().lightbox_id || a(n)
                        }
                        return i
                    }, e.attachEvent("onEventDeleted", function(t) {
                        if (!e.config.key_nav) return !0;
                        if (r.isEnabled()) {
                            var a = r.getActiveNode();
                            a.eventId == t && r.setActiveNode(new e.$keyboardNavigation.TimeSlot)
                        }
                        return !0
                    }), e.attachEvent("onClearAll", function() {
                        return e.config.key_nav ? void(r.isEnabled() && r.getActiveNode() instanceof e.$keyboardNavigation.Event && r.setActiveNode(new e.$keyboardNavigation.TimeSlot)) : !0
                    })
                    ...
                    function a(t) {
                        var a = t.target || t.srcElement,
                            r = e._locate_css(t, "dhx_cal_prev_button", !1),
                            n = e._locate_css(t, "dhx_cal_next_button", !1),
                            s = e._locate_css(t, "dhx_year_body", !1),
                            d = 0,
                            o = 0;
                        if (s) {
                            for (var l, c, h = a; h && "td" != h.tagName.toLowerCase();) h = h.parentNode;
                            if (h && (c = h, l = c.parentNode), l && c) {
                                for (var _ = l.parentNode.querySelectorAll("tr"), u = 0; u < _.length; u++)
                                    if (_[u] == l) {
                                        d = u;
                                        break
                                    }
                        ...
                        i.delay(function() {
                            if (r || n || s) {
                                var t;
                                r ? (t = new e.$keyboardNavigation.MinicalButton(g, 0), i.setActiveNode(new e.$keyboardNavigation.MinicalButton(g, 0))) : n ? t = new e.$keyboardNavigation.MinicalButton(g, 1) : s && (t = new e.$keyboardNavigation.MinicalCell(g, d, o)), t && (i.enable(), t.isValid() && (i.activeNode = null,
                                    i.setActiveNode(t)))
                            }
                        })
                    }
                    ...
                    if (e.renderCalendar) {
                        var r = e.renderCalendar;
                        e.renderCalendar = function() {
                            var n = r.apply(this, arguments),
                                s = e.$keyboardNavigation._minicalendars;
                            e.eventRemove(n, "click", a), e.event(n, "click", a), e.eventRemove(n, "focus", t), e.event(n, "focus", t);
                            for (var d = !1, o = 0; o < s.length; o++)
                                if (s[o] == n) {
                                    d = !0;
                                    break
                                }
                            if (d || s.push(n), i.isEnabled()) {
                                var l = i.getActiveNode();
                                l && l.container == n ? i.focusNode(l) : n.setAttribute("tabindex", "0")
                            } else n.setAttribute("tabindex", "0");
                            return n
                        }
                    }
                    if (e.destroyCalendar) {
                        var n = e.destroyCalendar;
                ...
                else var r = e.attachEvent("onSchedulerReady", function() {
                ...
                setInterval(function() {
                    if (e.$container && e.$keyboardNavigation.isChildOf(e.$container, document.body)) {
                        var r = t();
                        r ? a(r) : !r && i.isEnabled() && setTimeout(function() {
