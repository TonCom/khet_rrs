...
(c) Dinamenta, UAB.
*/
scheduler.xy.map_date_width = 188, scheduler.xy.map_icon_width = 25, scheduler.xy.map_description_width = 400, scheduler.config.map_resolve_event_location = !0, scheduler.config.map_resolve_user_location = !0, scheduler.config.map_initial_position = new google.maps.LatLng(48.724, 8.215), scheduler.config.map_error_position = new google.maps.LatLng(15, 15), scheduler.config.map_infowindow_max_width = 300, scheduler.config.map_type = google.maps.MapTypeId.ROADMAP, scheduler.config.map_zoom_after_resolve = 15, scheduler.locale.labels.marker_geo_success = "It seems you are here.",
    scheduler.locale.labels.marker_geo_fail = "Sorry, could not get your current position using geolocation.", scheduler.templates.marker_date = scheduler.date.date_to_str("%Y-%m-%d %H:%i"), scheduler.templates.marker_text = function(e, t, a) {
        ...
        function a() {
            ...
            for (var t = scheduler._waiAria.mapAttrString(), a = "<div " + t + " class='dhx_map_area'>", r = 0; r < e.length; r++) {
                ...
                a += "<div " + t + " class='" + n + "' event_id='" + i.id + "' style='" + s + d + (i._text_style || "") + " width: " + (scheduler.xy.map_date_width + scheduler.xy.map_description_width + 2) + "px;'><div class='dhx_map_event_time' style='width: " + scheduler.xy.map_date_width + "px;' >" + scheduler.templates.map_time(i.start_date, i.end_date, i) + "</div>",
                    a += "<div " + l + " class='dhx_event_icon icon_details'>&nbsp;</div>", a += "<div class='line_description' style='width:" + (scheduler.xy.map_description_width - scheduler.xy.map_icon_width) + "px;'>" + scheduler.templates.map_text(i.start_date, i.end_date, i) + "</div></div>"
            }
        ...
        scheduler.attachEvent("onEventChanged", function(e, t) {
            if (this._latLngUpdate) this._latLngUpdate = !1;
                ...
                a.start_date < scheduler._min_date && a.end_date > scheduler._min_date || a.start_date < scheduler._max_date && a.end_date > scheduler._max_date || a.start_date.valueOf() >= scheduler._min_date && a.end_date.valueOf() <= scheduler._max_date ? (scheduler.map._markers[e] && scheduler.map._markers[e].setMap(null), h(a)) : (scheduler._selected_event_id = null, scheduler.map._infowindow.close(),
