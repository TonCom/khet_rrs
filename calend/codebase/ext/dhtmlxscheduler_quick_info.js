    ...
    function() {
        ...
        if (e != this._quick_info_box_id && this.config.show_quick_info) {
            ...
            t && (this._quick_info_box = this._init_quick_info(t),
                this._fill_quick_data(e), this._show_quick_info(t), this.callEvent("onQuickInfo", [e]))
        }
    ...
    function() {
        ...
        scheduler.hideQuickInfo = function(t) {
            ...
            if (this._quick_info_box_id = 0, a && a.parentNode) {
                var i = a.offsetWidth;
                if (scheduler.config.quick_info_detached) return this.callEvent("onAfterQuickInfo", [r]),
                    a.parentNode.removeChild(a);
                if ("auto" == a.style.right ? a.style.left = -i + "px" : a.style.right = -i + "px", t) a.parentNode.removeChild(a);
                else {
                    var n;
                    window.getComputedStyle ? n = window.getComputedStyle(a, null) : a.currentStyle && (n = a.currentStyle);
                    var s = e(n["transition-delay"]) + e(n["transition-duration"]);
                    setTimeout(function() {
