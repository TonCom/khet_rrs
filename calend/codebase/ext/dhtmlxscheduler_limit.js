...
scheduler.config.limit_start = null, scheduler.config.limit_end = null, scheduler.config.limit_view = !1, scheduler.config.check_limits = !0, scheduler.config.mark_now = !0, scheduler.config.display_marked_timespans = !0, scheduler._temp_limit_scope = function() {
    ...
    scheduler.blockTime = function(e, t, a) {
        ...
        a = a || r;
        for (var n = !0, s = new Date(t.start_date.valueOf()), d = scheduler.date.add(s, 1, "day"), o = scheduler._marked_timespans; s < t.end_date; s = scheduler.date.date_part(d),
            d = scheduler.date.add(s, 1, "day")) {
    ...
    scheduler._get_blocked_zones = function(e, t, a, r, i) {
            ...
            return !s(t) && scheduler.config.limit_start && scheduler.config.limit_end && (t.start_date < scheduler.config.limit_start && (t.start_date = new Date(scheduler.config.limit_start)), t.start_date.valueOf() >= scheduler.config.limit_end.valueOf() && (t.start_date = this.date.add(scheduler.config.limit_end, -1, "day")),
            ...
            if (scheduler._table_view && "month" == scheduler._mode)
                for (var a in this._scales) {
                    ...
                    for (var r = new Date(scheduler._min_date), i = 0, n = e.childNodes.length; n > i; i++) {
                        ...
                        s.firstChild && scheduler._getClassName(s.firstChild).indexOf("dhx_scale_hour") > -1 || (t.push.apply(t, scheduler._on_scale_add_marker(s, r)),
                            r = scheduler.date.add(r, 1, "day"))
                    }
            return t
            ...
            if (arguments.length || (scheduler._marked_timespans = {
                ...
                e.start_date && e.end_date || (void 0 !== e.days || e.type || (e.days = "fullweek"),
                    e.zones || (e.zones = "fullday"));
                var t = [];
