...
<html>
    <head>
        ...
        <title>สถานะจอง | จองโดยเจ้าหน้าที่</title>
			...
			<div class="container-fluid">
				...
				<?php $sql = $db->prepare("SELECT COUNT(ActivityId) AS countacti FROM activity 
                    ...
                    if ($row = $sql->fetch()) { ?> 					
						...
						style="padding: 0 15px 0 15px">เจ้าหน้าที่</span> : สถานะ <span class='label label-default' style="padding: 0 10px 0 10px">จอง</span> <?=($row["countacti"]!=0? number_format($row["countacti"]) :  "0" )?> รายการ</b></h3>
				<?php } ?>
