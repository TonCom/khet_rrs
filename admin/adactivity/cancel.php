...
<html>
    <head>
        ...
        <title>สถานะยกเลิก | จองโดยเจ้าหน้าที่</title>
		...
		<?php include "../include/banner.php"; ?>	
			...
			<div class="container-fluid">
				...
				<?php $sql = $db->prepare("SELECT COUNT(ActivityId) AS countacti FROM activity 
					...
					style="padding: 0 15px 0 15px">เจ้าหน้าที่</span> : สถานะ <span class='label label-danger' style="padding: 0 10px 0 10px">ยกเลิก</span> <?=($row["countacti"]!=0? 
