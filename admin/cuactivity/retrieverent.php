...
if($_POST["startdate"]&&$_POST["enddate"]&&$_POST["roomid"]&&$_POST["idactivity"]) {
	$startdate=$_POST["startdate"]; 
	$enddate=$_POST["enddate"];
	$roomid=$_POST["roomid"];	
	$idactivity=$_POST["idactivity"];
		$sql = $db->prepare("SELECT startdate,enddate,roomid from service 
		WHERE ((
    ...
    AND roomid=$roomid) AND idactivity!=$idactivity");
		$sql->execute();
